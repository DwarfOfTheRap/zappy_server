...
void	init_ressources(t_zappy *var)
{
	...
	add_ressource(var, 1, nb_square * RES_RATIO * (1 + var->nb_team / 2) /
			100 * 9 / 39);
	add_ressource(var, 2, nb_square * RES_RATIO * (1 + var->nb_team / 2) /
			100 * 8 / 39);
	add_ressource(var, 3, nb_square * RES_RATIO * (1 + var->nb_team / 2) /
			100 * 10 / 39);
	add_ressource(var, 4, nb_square * RES_RATIO * (1 + var->nb_team / 2) /
			100 * 5 / 39);
	add_ressource(var, 5, nb_square * RES_RATIO * (1 + var->nb_team / 2) /
			100 * 6 / 39);
	add_ressource(var, 6, nb_square * RES_RATIO * (1 + var->nb_team / 2) /
			100 / 39);
}
